...
class StyleGAN2EncoderDataset(data.Dataset):
    """Define dataset."""

    def __init__(self, root, transforms=get_transform()):
        """Init dataset."""
        super(StyleGAN2EncoderDataset, self).__init__()
...
def train_data(bs):
    ...
    train_ds = StyleGAN2EncoderDataset(train_dataset_rootdir, get_transform(train=True))
    print(train_ds)
...
def test_data(bs):
    ...
    test_ds = StyleGAN2EncoderDataset(test_dataset_rootdir, get_transform(train=False))
...
def stylegan2encoderDatasetTest():
    """Test dataset ..."""

    ds = StyleGAN2EncoderDataset(train_dataset_rootdir)
    print(ds)
    # src, tgt = ds[0]
